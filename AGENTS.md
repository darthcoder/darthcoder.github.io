...
Read `.claude/memory.md` on entry. It holds dated, cross-session notes — decisions in flight, open questions, and context the user wants carried forward. Append new entries when the user shares something worth remembering across sessions; update or remove entries that go stale.
