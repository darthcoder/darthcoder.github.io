...
1. [ ] What's the difference between direct tool use and MCP servers?
2. [ ] How do you define a tool contract (input/output/error handling)?
3. [ ] What happens if Claude calls a tool with invalid arguments?

### Structured Output

1. [ ] How do you enforce valid JSON output from Claude?
2. [ ] What's a retry loop for schema validation?

### Context Management

1. [ ] How does prompt caching help with long-running agents?
2. [ ] What's the difference between managing state explicitly vs. relying on the model's memory?
