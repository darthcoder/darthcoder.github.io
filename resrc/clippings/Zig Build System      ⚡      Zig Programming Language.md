...
+- install hello success
   +- compile exe hello Debug native success 651ms MaxRSS:146M
```
...
Build Summary: 3/3 steps succeeded
run success
+- run exe hello success 5ms
   +- compile exe hello Debug native success 819ms MaxRSS:152M
```
...
install success
+- install hello success
   +- compile exe hello ReleaseSmall x86_64-windows success 3s MaxRSS:158M
```
...
install success
+- install app success
   +- compile exe app Debug native success 871ms MaxRSS:138M
      +- options cached
```
...
+- install fizzbuzz success
   +- compile lib fizzbuzz Debug native success 119ms MaxRSS:95M
```
...
install success
+- install fizzbuzz success
   +- compile lib fizzbuzz Debug native success 959ms MaxRSS:137M
```
...
/home/ci/.cache/act/d8cdf0a56651da11/hostexecutor/zig-code/build-system/unit-testing/main.zig:4:34: error: struct 'array_list.Aligned(i32,null)' has no member named 'init'
    var list = std.ArrayList(i32).init(std.testing.allocator);
               ~~~~~~~~~~~~~~~~~~^~~~~
...
failed command: /home/ci/deps/zig-x86_64-linux-0.16.0/zig test -target aarch64-macos -mcpu baseline -Mroot=../../../.cache/act/d8cdf0a56651da11/hostexecutor/zig-code/build-system/unit-testing/main.zig --cache-dir /home/ci/cache --global-cache-dir /home/ci/cache --name test --zig-lib-dir /home/ci/deps/zig-x86_64-linux-0.16.0/lib/ --listen=-
...
/home/ci/deps/zig-x86_64-linux-0.16.0/lib/std/array_list.zig:576:12: note: struct declared here
    return struct {
           ^~~~~~
error: 1 compilation errors
failed command: /home/ci/deps/zig-x86_64-linux-0.16.0/zig test -Mroot=../../../.cache/act/d8cdf0a56651da11/hostexecutor/zig-code/build-system/unit-testing/main.zig --cache-dir /home/ci/cache --global-cache-dir /home/ci/cache --name test --zig-lib-dir /home/ci/deps/zig-x86_64-linux-0.16.0/lib/ --listen=-
...
/home/ci/deps/zig-x86_64-linux-0.16.0/lib/std/array_list.zig:576:12: note: struct declared here
    return struct {
           ^~~~~~
error: 1 compilation errors
failed command: /home/ci/deps/zig-x86_64-linux-0.16.0/zig test -target x86_64-linux -mcpu baseline -Mroot=../../../.cache/act/d8cdf0a56651da11/hostexecutor/zig-code/build-system/unit-testing/main.zig --cache-dir /home/ci/cache --global-cache-dir /home/ci/cache --name test --zig-lib-dir /home/ci/deps/zig-x86_64-linux-0.16.0/lib/ --listen=-
...
/home/ci/cache/o/7468da6d4205adb2dba290998e359b4e/build /home/ci/deps/zig-x86_64-linux-0.16.0/zig /home/ci/deps/zig-x86_64-linux-0.16.0/lib ../../../.cache/act/d8cdf0a56651da11/hostexecutor/zig-code/build-system/unit-testing /home/ci/cache /home/ci/cache --seed 0xafdb82de -Zf7a67d0f124095b0 test --summary all
```
...
install success
+- install zip success
   +- compile exe zip Debug native success 543ms MaxRSS:143M
```
...
|  +- run jq cached
+- install hello success
   +- compile exe hello Debug native success 906ms MaxRSS:141M
```
...
install success
+- install generated to word.txt success
|  +- run exe word_select (word.txt) success 16ms
|     +- compile exe word_select Debug native success 701ms MaxRSS:147M
+- install hello success
   +- compile exe hello Debug native success 702ms MaxRSS:141M
```
...
install success
+- install hello success
   +- compile exe hello Debug native success 667ms MaxRSS:139M
      +- run exe word_select (word.txt) success 9ms
         +- compile exe word_select Debug native success 883ms MaxRSS:148M
```
...
+- install hello success
   +- compile exe hello Debug native success 1s MaxRSS:142M
      +- run exe generate_struct (person.zig) success 10ms
         +- compile exe generate_struct Debug native success 600ms MaxRSS:146M
```
...
+- install generated to project.tar.gz success
   +- run tar (project.tar.gz) success 463ms
      +- WriteFile project/app success
         +- compile exe app Debug native success 876ms MaxRSS:138M
```
...
install success
+- install hello success
|  +- compile exe hello ReleaseSafe aarch64-macos success 21s MaxRSS:408M
+- install hello success
|  +- compile exe hello ReleaseSafe aarch64-linux success 28s MaxRSS:483M
+- install hello success
|  +- compile exe hello ReleaseSafe x86_64-linux-gnu success 25s MaxRSS:439M
+- install hello success
|  +- compile exe hello ReleaseSafe x86_64-linux-musl success 25s MaxRSS:436M
+- install hello success
   +- compile exe hello ReleaseSafe x86_64-windows success 20s MaxRSS:364M
```
