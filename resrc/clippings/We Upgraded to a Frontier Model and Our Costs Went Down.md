---
title: "We Upgraded to a Frontier Model and Our Costs Went Down"
source: "https://www.mendral.com/blog/frontier-model-lower-costs"
author:
  - "[[Sam Alba & Andrea Luzzardi]]"
published: 2026-03-06
created: 2026-04-29
description: "We switched to a frontier model and our costs went down. Here's the architecture that made it possible."
tags:
  - "clippings"
---
Last week we wrote about [feeding terabytes of CI logs to an LLM](https://www.mendral.com/blog/llms-are-good-at-sql). Most of the questions on Hacker News weren't about the logs. They were about the agent: which models, how they coordinate, and how much it all costs.
...
![Pipeline: Haiku triager handles 80% of failures cheaply, 20% escalate to the Opus orchestrator which delegates to Haiku workers.](https://www.mendral.com/blog/frontier-model-lower-costs/pipeline.svg?dpl=dpl_BhxkJBWT4tWkkRe48qQ5Qryq8a94)
...
![The Opus orchestrator working through the Storybook investigation across two rounds, spawning Haiku sub-agents to fetch logs, query failure history, and verify what changed.](https://www.mendral.com/blog/frontier-model-lower-costs/orchestration.svg?dpl=dpl_BhxkJBWT4tWkkRe48qQ5Qryq8a94)
...
Result: `gyp ERR! not found: make`. re2@1.23.0 couldn't compile because `make` wasn't on the runner.
